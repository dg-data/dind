...
RUN /bin/bash -c "micromamba activate python3.7 && \
...
RUN /bin/bash -c "micromamba activate python3.7 && python -m ipykernel install --name python3.7 --display-name 'Python 3.7'"
